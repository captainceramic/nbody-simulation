...
int main(int argc, char *argv[]) {
  ...
  for(int i = 0; i < NUM_TIMESTEPS; i++) {
    ...
    printf("body 1 velocity: (%03f, %03f, %03f)\n",
	   velocity[0][0], velocity[0][1], velocity[0][2]);
    printf("body 2 velocity: (%03f, %03f, %03f)\n",
	   velocity[1][0], velocity[1][1], velocity[1][2]);
    ...
    /* Calculate the potential and kinetic energy to determine
